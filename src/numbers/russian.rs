...
const ORD_Y_SUFFIXES: &[&str] = &[
    "ый", "ая", "ое", "ые", "ого", "ой", "ых", "ому", "ым", "ом", "ыми", "ую",
];

const ORD_OY_SUFFIXES: &[&str] = &[
    "ой", "ая", "ое", "ые", "ого", "ой", "ых", "ому", "ым", "ом", "ыми", "ую",
];

const ORD_IY_SUFFIXES: &[&str] = &[
    "ий", "ья", "ье", "ьи", "ьего", "ьей", "ьих", "ьему", "ьим", "ьем", "ьими", "ью",
];
...
mod tests {
    ...
    fn compound() {
        ...
        assert_eq!(
            parse(&["одна", "тысяча", "девятьсот", "девяносто"]),
            Some((4, 1990))
        );
